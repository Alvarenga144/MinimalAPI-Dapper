...
namespace MinimalAPIsMovies.Repositories
{
    public class UsersRepository : IUsersRepository
    {
        ...
        public async Task<IdentityUser?> GetByEmail(string normalizedEmail)
        {
            ...
            {
                return await connection.QuerySingleOrDefaultAsync<IdentityUser>("Users_GetByEmail", new { normalizedEmail }, commandType: CommandType.StoredProcedure);
            }
        }
        ...
        {
            var sql = @"INSERT INTO UsersClaims (UserId, ClaimType, ClaimValue) VALUES (@Id, @Type, @Value)";
